   ...
   <body>
      ...
      <section class="contact py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">TÀI KHOẢN CÁ NHÂN</h3>
            <div class="contact-list-grid">
           &emsp;&emsp;&emsp;&emsp;   
            <div><label><b>&emsp;&emsp;&emsp;&emsp;TÊN TÀI KHOẢN : ${user1.email}</b></label></div>
           &emsp;&emsp;&emsp;&emsp;    
           <div><label><b>&emsp;&emsp;&emsp;&emsp;PASSWORD       : ${user1.password}</b></label></div>
           &emsp;&emsp;&emsp;&emsp;   
            <div><label><b>&emsp;&emsp;&emsp;&emsp;TÊN NGƯỜI DÙNG: ${user1.name}</b></label></div>
            &emsp;&emsp;&emsp;&emsp;   
            <div><label><b>&emsp;&emsp;&emsp;&emsp;ĐỊA CHỈ       : ${user1.address}</b></label></div>
            </div>
         </div>
         <!--//contact-map -->
      </section>
