         ...
         <div class="container-fluid">
            <div class="hedder-up row">
               ...
               <div class="col-lg-5 col-md-6 search-right">
                  <form action="search.htm" method="GET" class="form-inline my-lg-0">
							...
							<div class="tab2">
                              ...
                              <div class="tab4">
                                 <div class="row pay_info">
                                    ...
                                    <div class="col-md-6">
                                       <form class="cc-form"  action="buy.htm" method="get">
                                          <div class="clearfix">
                                             <div class="form-group form-group-cc-number">
                                                <label>Tên Khách Hàng</label>
                                                <input class="form-control" name="name" placeholder="Hoàng Ngọc Trung" type="text"><span class="cc-card-icon"></span>
                                             </div>
                                          ...
                                          <div class="form-group form-group-cc-cvc">
                                             ...
                                             <div class="form-group form-group-cc-name">
                                                ...
                                                <input class="form-control" class="security-code form-control" name="quantity"type="text" placeholder="xx">
                                             </div>
