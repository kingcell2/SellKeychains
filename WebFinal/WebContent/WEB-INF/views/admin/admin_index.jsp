            ...
            <div class="container-fluid">
               <div class="hedder-up row">
                  <div class="col-lg-3 col-md-3 logo-head">
                     <h1><a class="fas fa-fire" href="http://localhost:8080/WebFinal/admin/admin_index.htm"> Dororo Shop</a></h1>
                  </div>
                  <div class="col-lg-5 col-md-6 search-right">
                     <form  action="admin/search.htm" method="GET">
               ...
               <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                  <ul class="navbar-nav ">
                     <li class="nav-item active">
                        <a class="nav-link" href="http://localhost:8080/WebFinal/admin/index.htm">TRANG CHỦ <span class="sr-only">(current)</span></a>
                     </li>
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           <a class="nav-link" href="http://localhost:8080/WebFinal/admin/user.htm">QUẢN LÝ TÀI KHOẢN</a>
                           <a class="nav-link" href="http://localhost:8080/WebFinal/admin/product.htm">QUẢN LÝ SẢN PHẨM</a>
               ...
               <c:forEach var="item" items="${listMocKhoa}">
                  <li>  
                     ...
                     <div class="agileinfo_port_grid">
                        ...
                        <div class="outs_more-buttn">
                           <a href="http://localhost:8080/WebFinal/admin/product/1.htm">XEM THÊM</a>  
