...
<html lang="zxx">
   <head>      <link rel="shortcut icon" href="images/logo.png">	 
      ...
      <title>DORORO SHOP - checkout</title>
      <!--meta tags -->
      <meta charset="UTF-8">
            ...
            <div class="container-fluid">
               <div class="hedder-up row">
                  <div class="col-lg-3 col-md-3 logo-head">
                     <h1><a class="fas fa-fire" href="index.jsp"> Dororo Shop</a></h1>
                  </div>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
               ...
               <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                  <ul class="navbar-nav ">
                     ...
                     <li class="nav-item">
                        <a href="about.jsp" class="nav-link">THÔNG TIN</a>
                     </li>
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           <a class="nav-link" href="product_mk.jsp">MÓC KHÓA</a>
                           <a class="nav-link " href="product_mh.jsp">MÔ HÌNH</a>                         
                        </div>
                     </li>
                     <li class="nav-item">
